...
const SITE = {
  ...
  heroSubtext: "From raw footage to viral-ready cuts. I transform creator and brand vision into cinematic content that holds attention — and converts.",
  ...
  showreelUploadedUrl: "https://res.cloudinary.com/rfjb7ele/video/upload/v1788005053/Showreel_Cape.mp4",
  //
  // B) YouTube link — paste your youtube.com/watch or youtu.be link here:
  showreelYouTubeUrl: "",
  //
  // C) Static thumbnail only (used when both above are empty)
  showreelThumb: "https://images.unsplash.com/photo-1700922180758-b335f78a3d59?w=1200&h=675&fit=crop&auto=format",
  ...
  contactSubtext: "Slots are limited. Drop an inquiry and I'll get back within 24 hours.",
...
const clients = [
  { name: "Golf Busters",  niche: "Golf Channel",   subs: "82K Subs",      avatar: logoGolfBusters },
  { name: "Better Gaming", niche: "Tech Reviews",   subs: "40K Subs",      avatar: logoBetterGaming },
  { name: "The Nut",       niche: "Gaming Channel", subs: "1.26K Subs",    avatar: logoTheNut },
  { name: "SUL",           niche: "Skincare Brand", subs: "50K Followers", avatar: logoSul },
];
...
const projects = [
  {
    ...
    quote: "Delivered 7,000 views for a creator with under 400 subscribers. 17× above their usual baseline.",
  },
  {
    ...
    quote: "No footage, no assets, no templates. Script, visuals, motion, and voice all conceived and built from the ground up.",
  },
  {
    title: "This New Ridiculously Easy Way to Simplify Your Swing Requires No Practice",
    category: "YouTube Video",
    ...
    quote: "Took a channel averaging 650 views and delivered a 42,000-view video. A 64× leap in a single upload.",
  },
  {
    ...
    quote: "Trusted with tight deadlines. Consistently delivering broadcast-quality edits within the same working day.",
  },
];
...
const shorts = [
  {
    ...
    category: "Reel",
    videoSrc: "https://res.cloudinary.com/rfjb7ele/video/upload/w_360,q_auto:low/v1789224156/Shortform_5sec.mp4",
  },
  {
    title: "Streamer Moment",
    category: "Gaming",
    videoSrc: "https://res.cloudinary.com/rfjb7ele/video/upload/w_360,q_auto:low/v1789224162/Streamer_Moment.mp4",
  },
  {
    title: "Motion Backgrounds",
    category: "Motion Graphics",
    videoSrc: "https://res.cloudinary.com/rfjb7ele/video/upload/w_360,q_auto:low/v1789224190/Backgrounds.mp4",
  },
  {
    title: "Viral Icons",
    category: "Animation",
    videoSrc: "https://res.cloudinary.com/rfjb7ele/video/upload/w_360,q_auto:low/v1789224198/Viral_Icons_Animated.mp4",
  },
];
...
const testimonials = [
  {
    quote: "Cape helped us across both long-form and short-form projects, and the experience was genuinely great. The results spoke for themselves: clean edits, strong pacing, and a clear understanding of what we needed. We were happy with the outcome and still are.",
    name: "Better Gaming",
    role: "Gaming Brand",
  ...
  {
    quote: "Absolutely nailed it. The edit came out exactly how we envisioned: sharp, engaging, and on-brand from start to finish. Delivered clean and fast. Working with Cape is effortless and the quality is always there.",
    name: "Golf Busters",
    role: "Sports Content",
  ...
  {
    quote: "We've come back to Cape multiple times now, and every single project has landed the way we wanted. Consistent quality, fast delivery, and he always gets the vision right. Wouldn't go anywhere else for our edits.",
    name: "SUL",
    role: "Skincare Brand",
    logo: logoSul,
    stars: 5,
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 16,
        overflow: "hidden",
        border: isActive ? "1px solid rgba(243,59,88,0.45)" : "1px solid #261f21",
        background: "#121011",
        zIndex,
      ...
      <div style={{ position: "relative", aspectRatio: "9/16" }}>
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: "linear-gradient(to top, rgba(6,5,5,0.92) 0%, transparent 55%)",
            pointerEvents: "none",
          }}
        />
        {/* Category badge */}
...
function AmbientVideoPlayer({ src }: { src: string }) {
  ...
  return (
    <div
      ref={(el) => { (glowRef as React.MutableRefObject<HTMLDivElement | null>).current = el; (wrapRef as React.MutableRefObject<HTMLDivElement | null>).current = el; }}
      style={{
        position: "relative",
        width: "100%",
        height: "100%",
        borderRadius: 20,
        boxShadow: "0 0 80px 20px rgba(243,59,88,0.45), 0 0 140px 40px rgba(243,59,88,0.2)",
        ...
        >
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(to top, rgba(6,5,5,0.7) 0%, transparent 60%)",
            }}
          />
          <div
            style={{
...
function PlayIcon({ size = 48 }: { size?: number }) {
  return (
    ...
    >
      <svg width={size * 0.38} height={size * 0.38} viewBox="0 0 24 24" fill="white">
        <polygon points="5,3 19,12 5,21" />
      </svg>
    </div>
  );
...
function YouTubeEmbed({ videoId, thumb, gradientDir }: { videoId: string; thumb: string; gradientDir: string }) {
  const [playing, setPlaying] = useState(false);
      ...
      >
        <div
          ...
          onMouseEnter={(e) => {
            ...
            (e.currentTarget as HTMLDivElement).style.boxShadow = "0 0 40px rgba(255,0,0,0.7)";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLDivElement).style.transform = "scale(1)";
            (e.currentTarget as HTMLDivElement).style.boxShadow = "0 0 28px rgba(255,0,0,0.5)";
          }}
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="white">
            <polygon points="5,3 19,12 5,21" />
...
export default function App() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!emailOk) { setEmailError("Please enter a valid email address."); return; }
    setEmailError("");
  ...
  return (
    <div style={{ background: "#060505", minHeight: "100vh", color: "#eeeded" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
          <img
            src={capeLogoImg}
            alt="Cape logo"
            style={{ width: isMobile ? 22 : 30, height: isMobile ? 22 : 30, objectFit: "contain", flexShrink: 0, transform: "rotate(35deg)" }}
          />
          <span
            style={{
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            (e.target as HTMLButtonElement).style.boxShadow = "0 0 20px rgba(167,10,64,0.5)";
          }}
          onMouseLeave={(e) => {
      ...
      >
        <div className="section-label" style={{ marginBottom: isMobile ? 10 : 20 }}>
          {SITE.heroEyebrow}
        </div>
        ...
        <h1
          style={{
            fontFamily: "Barlow Condensed, sans-serif",
            fontWeight: 900,
            fontSize: isMobile ? "clamp(44px, 12vw, 64px)" : "clamp(52px, 8vw, 96px)",
            lineHeight: 0.95,
        ...
        <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "center", gap: isMobile ? 10 : 12, justifyContent: "center", marginBottom: isMobile ? 36 : 72 }}>
          <button
            onClick={() => document.getElementById("contact")?.scrollIntoView({ behavior: "smooth" })}
            style={{
              background: "#f33b58",
            ...
            onMouseEnter={(e) => {
              (e.target as HTMLButtonElement).style.background = "#a70a40";
              (e.target as HTMLButtonElement).style.boxShadow = "0 0 28px rgba(167,10,64,0.55)";
            }}
            onMouseLeave={(e) => {
              (e.target as HTMLButtonElement).style.background = "#f33b58";
              (e.target as HTMLButtonElement).style.boxShadow = "none";
            ...
            <>
              ...
              <div
                style={{
                  position: "absolute",
                  inset: 0,
                  background: "linear-gradient(to top, rgba(6,5,5,0.8) 0%, transparent 60%)",
                }}
              />
              <div
                style={{
      ...
      >
        ...
        >
          <div
            style={{ flex: 1, height: 1, background: "linear-gradient(to right, transparent, #261f21)" }}
          />
          <span
            className="section-label"
            style={{ fontFamily: "Inter, sans-serif", fontSize: 11, color: "#6b5c5c", letterSpacing: "0.2em" }}
          >
            {SITE.socialProofLabel}
          </span>
          <div
            style={{ flex: 1, height: 1, background: "linear-gradient(to left, transparent, #261f21)" }}
          />
        </div>
        ...
        >
          {clients.map((c) => (
            <div
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(243,59,88,0.3)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLDivElement).style.borderColor = "#261f21";
              }}
            >
              <img
                src={c.avatar}
                alt={c.name}
                style={{ width: isMobile ? 48 : 40, height: isMobile ? 48 : 40, borderRadius: 6, objectFit: "cover", objectPosition: "center", flexShrink: 0, background: "#1a1314", display: "block" }}
              />
              <div style={{ minWidth: 0 }}>
                ...
                <div style={{ fontFamily: "Inter, sans-serif", fontSize: isMobile ? 10 : 11, color: "#6b5c5c", marginBottom: 4, whiteSpace: "nowrap" }}>
                  {c.niche}
                </div>
                <span
                  style={{
      ...
      <section id="work" style={{ padding: isMobile ? "40px 20px" : "96px 40px", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          {projects.map((p, idx) => {
            ...
            const gradientDir = isMobile ? "to bottom" : (isEven ? "to right" : "to left");
            const videoId = getYouTubeId(p.videoUrl);
            const Thumb = (
              <div style={{ position: "relative", aspectRatio: "16/9", minWidth: 0, overflow: "hidden" }}>
                {videoId ? (
                  <YouTubeEmbed videoId={videoId} thumb={p.thumb} gradientDir={gradientDir} />
                ) : (
                  <>
                    <img
                      src={p.thumb}
                    ...
                    />
                    <div style={{ position: "absolute", inset: 0, background: `linear-gradient(${gradientDir}, transparent 65%, #121011 100%)` }} />
                    <div className="play-icon" style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <PlayIcon size={52} />
                    </div>
                  </>
                )}
            ...
            const Meta = (
              ...
              >
                ...
                {p.views && (
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#d5a9a9" strokeWidth="2">
      ...
      {/* ── SIGNATURE MOMENTS ── */}
      <section style={{ borderTop: "1px solid #1a1314", padding: isMobile ? "36px 12px" : "80px 40px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: isMobile ? 20 : 40 }}>
            <div className="section-label" style={{ marginBottom: 12 }}>Signature Moments</div>
            <h2 style={{ fontFamily: "Barlow Condensed, sans-serif", fontWeight: 800, fontSize: "clamp(36px,4vw,52px)", textTransform: "uppercase", letterSpacing: "0.01em", color: "#eeeded", margin: 0 }}>
          ...
          {(() => {
            ...
            const scale = isMobile ? Math.min(1, (windowWidth - padH) / gridW) : 1;
            const cell = { overflow: "hidden" as const, position: "relative" as const, background: "#0c0a0b" };
            const grids = [
            ...
            return (
              <div style={{ width: "100%", height: isMobile ? gridH * scale : "auto", overflow: "hidden" }}>
                <div style={{
                  display: "flex",
                  flexDirection: "column",
                  gap: 5,
                  ...
                  {grids.map((g, gi) => (
                    <div key={gi} style={{ display: "grid", gridTemplateColumns: g.cols, gridTemplateRows: g.rows, gap: 5 }}>
                      {g.data.map((clip, i) => (
                        <div key={i} style={{ ...cell, gridRow: clip.gridRow, gridColumn: clip.gridColumn }}>
      ...
      >
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {([-1, 1] as const).map((dir) => (
              <button
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.borderColor = "#f33b58";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.borderColor = "#261f21";
                }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#d5a9a9" strokeWidth="2" strokeLinecap="round">
        ...
        >
          {([-2, -1, 0, 1, 2] as const).map((offset) => {
            ...
            const side = 120;
            const sideOffset = isMobile ? 0 : (activeShort % 2 === 0 ? -side : side);
            return (
              <ShortCard
                key={offset}
                s={s}
                ...
                onClick={() => { if (offset !== 0) stepShort(offset); }}
              />
            );
          })}
        </div>
      ...
      {/* ── CONTACT ── */}
      <section id="contact" style={{ padding: isMobile ? "60px 20px" : "100px 40px", maxWidth: 1200, margin: "0 auto" }}>
        {/* CTA Banner */}
        <div
          style={{
        ...
        >
          ...
          <div
            style={{
              ...
              width: 500,
              height: 300,
              background: "radial-gradient(ellipse, rgba(167,10,64,0.18) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
        ...
        {submitted ? (
          ...
          >
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#f33b58" strokeWidth="2.5" strokeLinecap="round">
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: 14, color: "#d5a9a9" }}>
          ...
          >
            ...
            <div>
              ...
              />
              {emailError && (
                <p style={{ fontFamily: "Inter, sans-serif", fontSize: 11, color: "#f33b58", margin: "6px 0 0" }}>
                  {emailError}
                </p>
              )}
            </div>
            ...
            <div style={{ gridColumn: "1 / -1", display: "flex", justifyContent: isMobile ? "center" : "flex-end" }}>
              <button
                type="submit"
                style={{
                  background: "#f33b58",
        ...
        >
          ...
          >
            <span style={{ color: "#eeeded" }}>{SITE.brandPart1}</span><span style={{ color: "#f33b58" }}>{SITE.brandAccent}</span><span style={{ color: "#eeeded" }}>{SITE.brandPart2}</span>
          </span>
          ...
          {SITE.socialLinks.map((link, i) => (
            <Fragment key={link.label}>
              <a
                ...
                onMouseEnter={(e) => ((e.target as HTMLAnchorElement).style.color = "#f33b58")}
                onMouseLeave={(e) => ((e.target as HTMLAnchorElement).style.color = "#6b5c5c")}
              >
                {link.label}
              </a>
